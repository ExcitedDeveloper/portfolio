        ...
        >
          <div className="project-content">
            <div>
              ...
              <h3 className="project-title">
                <a
                  href="https://minesweeper.stevehunley.dev"
                  rel="noopener noreferrer"
                  target="_blank"
                >
                  Minesweeper Clone
              ...
              <div className="project-description">
                <p>
                  A clone of Minesweeper developed with{' '}
              ...
              <div className="project-links">
                <a
                  href="https://github.com/ExcitedDeveloper/minesweeper"
                  aria-label="GitHub Link"
                  rel="noopener noreferrer"
                  target="_blank"
                >
          ...
          {(windowSize.width === undefined || windowSize.width >= 768) && (
            <div className="project-image">
              <div className="image-wrapper image-wrapper-constrained img">
                <div style={{ maxWidth: '22rem', display: 'block' }}>
                  <img
                    alt="Minesweeper Clone"
                    src="MinesweeperClone.PNG"
                    style={{
                      maxWidth: '100%',
                      display: 'block',
                      position: 'static'
          ...
          {windowSize.width !== undefined && windowSize.width < 768 && (
            <div
              className="project-image"
              style={{
                backgroundImage: 'url("MinesweeperClone.PNG")',
                backgroundSize: 'contain',
                backgroundPosition: 'center',
                backgroundRepeat: 'no-repeat',
                gridColumn: '1/-1'
